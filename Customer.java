...
public class Customer implements Comparable<Customer>
{
	...
	// Returns the cart instance variable
	public Cart getCart()
	{
		return this.cart;
	}
	
	// Sets the cart instance variable to the cart that is passed as a parameter
	...
	// Uses the compareTo method from the Comparable interface to compare names of customers
